# -*- coding: utf-8 -*-
"""
Created on Sun Nov 23 22:22:07 2025
...
for epoch in range(epochs):
    ...
    if test_acc > best_acc:
        ...
        torch.save(best_state, "resnet18_cifar10_best.pth")
...
print("Best model (by test acc) → resnet18_cifar10_best.pth with acc =", best_acc)
...
model = ViT(
    ...
    patch_size = 4,      # 32 / 4 = 8 → 8x8 = 64 patches (same #tokens as 64/8)
...
for epoch in range(epochs):
    ...
    if test_acc > best_acc:
        best_acc = test_acc
        best_state = model.state_dict()
        torch.save(best_state, "slvit_cifar10_best.pth")
...
print("Best model (by test acc) → slvit_cifar10_best.pth with acc =", best_acc)
